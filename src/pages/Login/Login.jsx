...
import pic from '../../assets/cyber-security-network-padlock-icon-internet-technology-networking-businessman-protecting-data-personal-information-tablet-virtual-interface-data-protection-privacy-concept-gdpr-eu_150455-20541.avif'
                        ...
                        <div className="w-full max-w-xl xl:px-8 xl:w-5/12 lg:mr-20">
                            <div className="bg-white rounded shadow-2xl p-7 sm:p-10">
                                ...
                                <form onSubmit={handleSubmit}>
                                    ...
                                    <label className="label" onSubmit={handleReset}>
